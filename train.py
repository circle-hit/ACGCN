...
class Instructor:
    def __init__(self, opt):
        ...
        self.train_data_loader = BucketIterator(data=absa_dataset.train_data, batch_size=opt.batch_size, embed_type=opt.embed_type, shuffle=True)
    ...
    def run(self, repeats=8):
        ...
        f_out = open('log/'+self.opt.model_name+'_'+self.opt.dataset+'high_32_val.txt', 'w', encoding='utf-8')
